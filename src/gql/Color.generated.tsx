...
export type BasicColorInfoFragment = { __typename?: 'Color', name: string, value: string };

export type BasicColorInfoWithIdFragment = { __typename?: 'Color', id: number, name: string, value: string };
